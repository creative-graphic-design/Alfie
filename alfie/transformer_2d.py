...
logger = logging.get_logger(__name__)  # pylint: disable=invalid-name # pylint: disable=invalid-name
...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    # from https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/unets/unet_2d_condition.py#L693
    @property
    ...
    # from https://github.com/huggingface/diffusers/blob/main/src/diffusers/models/unets/unet_2d_condition.py#L716
